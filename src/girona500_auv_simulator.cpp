...
{
	ros::init(argc, argv, "girona500_auv_simulator", ros::init_options::NoSigintHandler);
	...
	G500AUVSimulationManager manager(500.0);
	sf::GraphicalSimulationApp app("GIRONA500 AUV Simulator", std::string(argv[1]), s, h, &manager); 
	app.Run();
